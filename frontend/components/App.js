...
export default function App() {
  ...
  const onChange = evt => {
   ...
   setvalue(prevValues=>({...prevValues, [id]: value}))
  }
  const edit = id => {
      ...
      <div id="membersForm">
        ...
        <form onSubmit={onSubmit}>
          <div>
            ...
            <input value={value.fname} onChange={onChange} id="fname" type="text" placeholder="Type First Name" />
          </div>

          <div>
            <label htmlFor="lname">Last Name </label>
            <input value={value.lname} onChange={onChange} id="lname" type="text" placeholder="Type Last Name" />
          </div>

          <div>
            <label htmlFor="bio">Bio </label>
            <textarea value={value.bio} onChange={onChange} id="bio" placeholder="Type Bio" />
          </div>
